...
This directory carries a prepared excerpt of Common Paper's **Service Level Agreement** standard
agreement, licensed under the Creative Commons Attribution 4.0 International licence.

- Upstream repository: https://github.com/CommonPaper/SLA
- File: `sla.md`
- Tags compared: `1.0` (source) to `2.0` (test)
- Licence: CC BY 4.0 -- https://creativecommons.org/licenses/by/4.0/

**Attribution.** Common Paper Service Level Agreement, copyright Common Paper, Inc., licensed under
...
was reworded and no content was added or removed: `strip_inline_html`, `promote_span_ids_to_labels`. See
