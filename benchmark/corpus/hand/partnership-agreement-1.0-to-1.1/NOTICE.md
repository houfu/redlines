...
This directory carries a prepared excerpt of Common Paper's **Partnership Agreement** standard
agreement, licensed under the Creative Commons Attribution 4.0 International licence.

- Upstream repository: https://github.com/CommonPaper/Partnership-Agreement
- File: `Partnership-Agreement.md`
- Tags compared: `1.0` (source) to `1.1` (test)
- Licence: CC BY 4.0 -- https://creativecommons.org/licenses/by/4.0/

**Attribution.** Common Paper Partnership Agreement, copyright Common Paper, Inc., licensed under
