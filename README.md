...
Sentence mode preserves the input's paragraph boundaries (fixed in 0.6.x): sentences are anchored within their paragraph, so the output is not reflowed one sentence per paragraph.
