...
description: Invocation, output formats, JSON structure, error handling and integration patterns for calling redlines from agents and automation.
---

:::caution[This is the 0.6 guide]
It documents the current release and is accurate for it. For 1.0 it is being
replaced by a short contract page plus task pages whose code comes from
`examples/`, with the machine-readable parts — schemas, `llms.txt`, the MCP tool
descriptions — carrying what prose used to. See
[ADR-0027](/redlines/project/adr/0027-agent-docs-machine-surface/).
:::
